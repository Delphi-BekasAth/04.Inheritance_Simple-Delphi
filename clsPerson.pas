...
type
  TPerson = class (TObject)
    protected   //Διαβάζονται και από τις υποκλάσεις
    name: string;
    age: integer;
    ...
    procedure PrintInfo; virtual;   //Μπορεί να γίνει επικάλλυψη από τις υποκλάσεις
    procedure CustEmail; virtual; abstract;

    function GetInfo:string; virtual;  //Μπορεί να γίνει επικάλλυψη από τις υποκλάσεις
